...
--
-- Table structure for table `condt`
--

DROP TABLE IF EXISTS `condt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `condt` (
  `id` int(32) DEFAULT NULL,
  `uri` varchar(64) DEFAULT NULL,
  `nilai` varchar(32) DEFAULT NULL,
  `status` varchar(32) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `condt`
--
...
-- Dump completed on 2016-09-09 17:22:29

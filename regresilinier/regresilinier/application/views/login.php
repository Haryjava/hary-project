                ...
                <form action="" method="post">
                    <?php
                        if(isset($_POST['submit'])){
                            ...
                            if($email = "h4ry.oop@gmail.com" && $password = "masukaja"){
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" name="mail" class="form-control" placeholder="Email" id="mail"/>
